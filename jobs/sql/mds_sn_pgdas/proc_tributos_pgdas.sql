...
WITH fa_03110 AS (
  SELECT 
    ...
    PA
  FROM `infra-itaborai.mds_sn_pgdas.valor_receita_atividade_fa_03110`  
)
...
, fb_03120 AS (
  SELECT 
    ...
    Valor_apurado_de_PIS,
    PA
  FROM `infra-itaborai.mds_sn_pgdas.valor_receita_atividade_fb_03120` 
), 
 ...
 fc_03130 AS (
  SELECT 
    ...
    Valor_apurado_de_PIS,
    PA
  FROM `infra-itaborai.mds_sn_pgdas.valor_receita_atividade_fc_03130` 
), 
pgdas_filtro AS (
  SELECT 
